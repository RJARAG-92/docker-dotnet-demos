...
namespace Demo03.Requests.Application.UseCases.RejectRequest
{
    public sealed class RejectRequestHandler
    {
        ...
        public RejectRequestHandler(IRequestRepository repo, IEventBus bus, IClock clock, ICacheStore cache, IUserContext user, IAuditWriter audit)
        {
        ...
        public async Task HandleAsync(RejectRequestCommand cmd, CancellationToken ct)
        {
            ...
            request.Reject(cmd.Reason, _clock.UtcNow);
